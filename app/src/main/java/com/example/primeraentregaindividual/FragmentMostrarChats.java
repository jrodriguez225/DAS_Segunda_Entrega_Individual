...
// Fragment de la actividad mostrar chats
public class FragmentMostrarChats extends Fragment {
    ...
    public interface ListenerFragment{
        void mostrarChats(View view);
    }

    // Al crear el fragment se establece el layout
    public View onCreateView(@NonNull LayoutInflater inflater,
                             @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_mostrar_chats,container,false);
        return v;
    }
